...
export async function getDocuments({ apiKey, apiUrl, debug, collectionId, search = '', take = 10, skip = 0, extended = false, status = 'all', nodes = 'all', edges = 'all', vectors = 'all', category = 'all' }) {
