...
import { CreateDocumentRequest, CreateDocumentResponse } from 'collection/document/create';
import { GetDocumentsRequest, GetDocumentsResponse } from 'collection/document/get';
import { GetDocumentResponse } from 'collection/document/getId';
import { PresignDocumentRequest, PresignDocumentResponse } from 'collection/document/presign';
import { UpdateDocumentRequest } from 'collection/document/update';
import { GetCollectionsRequest, GetCollectionsResponse } from 'collection/get';
import { GetCollectionResponse } from 'collection/getId';
import { GetJobsRequest, GetJobsResponse } from 'collection/job/get';
import { GetJobResponse } from 'collection/job/getId';
import { ReprocessDocumentsRequest, ReprocessDocumentsResponse } from 'collection/job/reprocess';
import { FeaturesQueryRequest, FeaturesQueryResponse } from 'collection/query/features';
import { SearchQueryResponse } from 'collection/query/search';
import { TablesQueryRequest, TablesQueryResponse } from 'collection/query/table';
...
import { GetOrganizationsRequest, GetOrganizationsResponse } from 'organization/get';
import { GetOrganizationResponse } from 'organization/getId';
import { AddMembersRequest } from 'organization/members/add';
import { RemoveMembersRequest } from 'organization/members/remove';
import { UpdateOrganizationRequest } from 'organization/update';
...
export declare class Gestell {
    ...
    collection: {
        ...
        query: {
             ...
             */
            search: (collectionId: string, payload: QueryPayload) => Promise<SearchQueryResponse>;
            /**
             ...
             */
            prompt: (collectionId: string, payload: PromptPayload) => Promise<ReadableStream<string>>;
            /**
             ...
             */
            features: (collectionId: string, payload: FeaturesQueryRequest) => Promise<FeaturesQueryResponse>;
            /**
             ...
             */
            table: (collectionId: string, payload: TablesQueryRequest) => Promise<TablesQueryResponse>;
        };
        /**
        ...
        document: {
             ...
             */
            get: (collectionId: string, documentId: string) => Promise<GetDocumentResponse>;
            /**
             ...
             *   - `dateUpdated`: The date the document was last updated.
             */
            list: (collectionId: string, payload?: GetDocumentsRequest) => Promise<GetDocumentsResponse>;
            /**
             ...
             */
            presign: (collectionId: string, payload: PresignDocumentRequest) => Promise<PresignDocumentResponse>;
            /**
             ...
             */
            create: (collectionId: string, payload: CreateDocumentRequest) => Promise<CreateDocumentResponse>;
            /**
             ...
             */
            update: (collectionId: string, documentId: string, payload: UpdateDocumentRequest) => Promise<BaseResponse>;
            /**
             ...
             */
            delete: (collectionId: string, documentId: string) => Promise<BaseResponse>;
        };
        /**
        ...
        job: {
             ...
             */
            list: (collectionId: string, payload?: GetJobsRequest) => Promise<GetJobsResponse>;
            /**
             ...
             */
            reprocess: (collectionId: string, payload: ReprocessDocumentsRequest) => Promise<ReprocessDocumentsResponse>;
            /**
