 ...
 */
export type CollectionType = /** frame: When you only want the OCR outputs. */ 'frame' | /** searchable-frame: Lighter version of canonized collections that are for search based reasoning. */ 'searchable-frame' | /** canon: Complete canonized collection that has the best search based reasoning capabilities. */ 'canon' | /** features: Specialized collection for category extractions of content. */ 'features';
/**
 * Classification of PII/PHI, select the one model and type most optimal for your use case
 */
export type PiiType = /** Standard personal data without specialized legal or health context. */ 'generic' | /** Information with legal or regulatory implications (e.g., SSN, license numbers). */ 'legal' | /** Protected health information subject to medical privacy regulations. */ 'medical';
/**
 * Supported categories for organizing content in collections.
 */
export type CategoryType = /** Filter content based on the category instructions */ 'content' | /** Conceputalized versions of content. Useful for read heavy contexts */ 'concepts' | /** Feature extraction of labels. */ 'features' | /** Structured tabular data with rows and columns. */ 'table';
/**
