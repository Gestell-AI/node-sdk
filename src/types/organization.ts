...
export type OrganizationPlan =
  | /** Evaluation tier with limited features. */ 'preview'
  | /** Individual developer tier for testing or hobby projects. */ 'developer'
  | /** Entry-level tier for small teams or startups. */ 'starter'
  | /** Scaled tier for growing teams with increased usage. */ 'scale'
  | /** Enterprise-grade tier with custom SLAs and support. */ 'enterprise'
...
export const MembershipRoles: MembershipRole[] = ['member', 'admin']
