...
export type LayoutType =
  | /** Standard paginated document (e.g., PDF, Word). */ 'document'
  | /** Single-image input (e.g., JPG, PNG). */ 'photo'
  | /** Audio file input for transcription or segmentation. */ 'audio'
  | /** Video file input for frame and audio-layout processing. */ 'video'
