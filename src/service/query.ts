...
import { PromptRequestBody, SearchRequestBody } from '@gestell/types/query'
...
export default function QueryService(
  ...
  async function promptFn(payload: PromptRequestBody) {
    return promptQuery({ ...options, ...payload })
  }

  async function searchFn(payload: SearchRequestBody) {
    return searchQuery({ ...options, ...payload })
  }

  async function featuresFn(payload: FeaturesQueryRequest) {
    return featuresQuery({ ...options, ...payload })
  }

  async function tableFn(payload: TablesQueryRequest) {
    return tablesQuery({ ...options, ...payload })
  }

  async function featuresExportFn(payload: ExportFeaturesRequest) {
    return exportFeatures({ ...options, ...payload })
  }

  async function tableExportFn(payload: ExportTableRequest) {
    return exportTable({ ...options, ...payload })
  }
