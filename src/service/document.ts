...
export default function DocumentService(
  ...
  async function get(payload: GetDocumentRequest) {
    return getDocument({ ...options, ...payload })
  }

  async function exportDocumentFn(payload: ExportDocumentRequest) {
    return exportDocument({ ...options, ...payload })
  }

  async function list(payload: GetDocumentsRequest) {
    return getDocuments({ ...options, ...payload })
  }

  async function presign(payload: PresignDocumentRequest) {
    return presignDocument({ ...options, ...payload })
  }

  async function create(payload: CreateDocumentRequest) {
    return createDocument({ ...options, ...payload })
  }

  async function upload(payload: UploadDocumentRequest) {
    return uploadDocument({ ...options, ...payload })
  }

  async function update(payload: UpdateDocumentRequest) {
    return updateDocument({ ...options, ...payload })
  }

  async function deleteDocumentFn(payload: DeleteDocumentRequest) {
    return deleteDocument({ ...options, ...payload })
  }
